...
class CrossModule(nn.Module):
    def __init__(self, num_class, in_channels, anchors=16, out_channels=2):
        ...
        anchors = int(anchors)
        self.CP1 = CrossPointNet(in_channels, anchors, int(256/anchors), [64],  [[32, 64, 128]], int(1024/anchors), out_channels, DFPS=False, time_encoding=False)
        """
         in_channels = out_channels + n_per_sample
        """
        #  attention = True
        # self.fe2 = PointFeatureNet(64, [56, 128], 128+out_channels, [[64, 64, 128], [128, 128, 256]])
        self.fe2 = PointFeatureNet(64, [56], 128 + out_channels, [[64, 64, 128]])
        # self.fe2 = PointFeatureNet(128, [256], 192+64, [[128, 128, 256]])
        self.fe3 = PointNetSetAbstraction(128 + 3, [256, 512])
